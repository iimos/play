...
var syscalls = SyscallMap{
	...
	unix.SYS_MMAP:                   makeSyscallInfo("mmap", Hex, Hex, MMapProt, MMapFlags, Hex, Hex),
	...
	unix.SYS_RT_SIGACTION:           makeSyscallInfo("rt_sigaction", Signal, Hex, Hex),
	...
	unix.SYS_MADVISE:                makeSyscallInfo("madvise", Hex, Hex, MADVFlags),
	...
	unix.SYS_ARCH_PRCTL:             makeSyscallInfo("arch_prctl", ArchPrctl, Hex),
	...
	unix.SYS_SCHED_SETAFFINITY: makeSyscallInfo("sched_setaffinity", PID, Dec, CPUSet),
	unix.SYS_SCHED_GETAFFINITY: makeSyscallInfo("sched_getaffinity", PID, Dec, CPUSet),
