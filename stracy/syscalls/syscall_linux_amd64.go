...
var syscalls = SyscallMap{
	...
	unix.SYS_IOCTL:                  makeSyscallInfo("ioctl", Hex, Hex, Hex, Hex),
	...
	unix.SYS_DUP:                    makeSyscallInfo("dup", Hex, Hex),
	unix.SYS_DUP2:                   makeSyscallInfo("dup2", Hex, Hex, Hex),
	...
	unix.SYS_SENDFILE:               makeSyscallInfo("sendfile", Hex, Hex, Hex, Hex, Hex),
	...
	unix.SYS_SENDTO:                 makeSyscallInfo("sendto", Hex, Hex, Hex, Hex, Hex, SockAddr, Hex),
	unix.SYS_RECVFROM:               makeSyscallInfo("recvfrom", Hex, Hex, Hex, Hex, Hex, PostSockAddr, SockLen),
	unix.SYS_SENDMSG:                makeSyscallInfo("sendmsg", Hex, Hex, SendMsgHdr, Hex),
	unix.SYS_RECVMSG:                makeSyscallInfo("recvmsg", Hex, Hex, RecvMsgHdr, Hex),
	unix.SYS_SHUTDOWN:               makeSyscallInfo("shutdown", Hex, Hex, Hex),
	...
	unix.SYS_EPOLL_CREATE:      makeSyscallInfo("epoll_create", Hex, Hex),
	...
	unix.SYS_EPOLL_WAIT:       makeSyscallInfo("epoll_wait", Hex, Hex, Hex, Hex, Hex),
	unix.SYS_EPOLL_CTL:        makeSyscallInfo("epoll_ctl", Hex, Hex, Hex, Hex, Hex),
	...
	unix.SYS_SPLICE:            makeSyscallInfo("splice", Hex, Hex, Hex, Hex, Hex, Hex, Hex),
	unix.SYS_TEE:               makeSyscallInfo("tee", Hex, Hex, Hex, Hex, Hex),
	...
	unix.SYS_EPOLL_PWAIT:       makeSyscallInfo("epoll_pwait", Hex, Hex, Hex, Hex, Hex, Hex, Hex),
	...
	unix.SYS_EPOLL_CREATE1:     makeSyscallInfo("epoll_create1", Hex, Hex),
	unix.SYS_DUP3:              makeSyscallInfo("dup3", Hex, Hex, Hex, Hex),
